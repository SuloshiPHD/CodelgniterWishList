 ...
 */
//class name of api should be a noun
class User extends \Restserver\Libraries\REST_Controller {
    ...
    public function users_put(){
        ...
        $idofuser = $this->put('id');
        $nameofuser = $this->put('name') . 'Suloshinie';
        $emailofuser = $this->put('email');
        $message = array('id '=> $idofuser, 'nameofuser' => $nameofuser, 'emailofuser'=> $emailofuser);

       //echo json_encode(array('id '=> $idofuser, 'nameofuser' => $nameofuser, 'emailofuser'=> $emailofuser));
